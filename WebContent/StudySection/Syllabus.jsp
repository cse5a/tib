...
<%@ page import="com.controller.GetPostSS" %>
<%@ page import="com.bean.NTSSBean" %>
<%@ page import="com.dao.DaoGT_SS" %>
...
<tr>
	<td align="right">
	<a href='StudySection/NewT_SS.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
