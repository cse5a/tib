...
<%@ page import="com.controller.GetPostSQ" %>
<%@ page import="com.bean.NTSQBean" %>
<%@ page import="com.dao.DaoGT_SQ" %>
...
<tr>
	<td align="right">
	<a href='StudySection/NewT_SQ.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
