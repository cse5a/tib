...
<%@ page import="com.controller.GetPostSSG" %>
<%@ page import="com.bean.NTSSGBean" %>
<%@ page import="com.dao.DaoGT_SSG" %>
...
<tr>
	<td align="right">
	<a href='StudentSection/NewT_SSG.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
