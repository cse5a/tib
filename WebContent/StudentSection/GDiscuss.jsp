...
<%@ page import="com.controller.GetPostSGD" %>
<%@ page import="com.bean.NTSGDBean" %>
<%@ page import="com.dao.DaoGT_SGD" %>
...
<tr>
	<td align="right">
	<a href='StudentSection/NewT_SGD.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
