...
<%@ page import="com.controller.GetPostAP" %>
<%@ page import="com.bean.NTAPBean" %>
...
<tr>
	<td align="right">
	<a href='AccountSection/NewT_AP.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
...
<table>
 ...
 <%
			...
			if(mylist!=null) 
			{
				...
				out.print("<table class='posts' cellspacing='0'><tr class='generic'><td>No topics were found.</td></tr></table>");
