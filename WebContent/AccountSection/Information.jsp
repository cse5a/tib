...
<%@ page import="com.controller.GetPostAI" %>
<%@ page import="com.bean.NTAIBean" %>
<%@ page import="com.dao.DaoGT_AI" %>
...
<tr>
	<td align="right">
	<a href='AccountSection/NewT_AI.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
