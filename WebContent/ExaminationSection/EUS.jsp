...
<%@ page import="com.controller.GetPostEUS" %>
<%@ page import="com.bean.NTEUSBean" %>
<%@ page import="com.dao.DaoGT_EUS" %>
...
<tr>
	<td align="right">
	<a href='ExaminationSection/NewT_EUS.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
