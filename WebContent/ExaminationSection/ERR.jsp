...
<%@ page import="com.controller.GetPostERR" %>
<%@ page import="com.bean.NTERRBean" %>
<%@ page import="com.dao.DaoGT_ERR" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Exam Rules & Regulations</title>
...
<tr>
	<td align="right">
	<a href='ExaminationSection/NewT_ERR.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
