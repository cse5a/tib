...
<%@ page import="com.controller.GetPostEIQ" %>
<%@ page import="com.bean.NTEIQBean" %>
<%@ page import="com.dao.DaoGT_EIQ" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Issues/Queries</title>
...
<tr>
	<td align="right">
	<a href='ExaminationSection/NewT_EIQ.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
