...
<%@ page import="com.controller.GetPostNII" %>
<%@ page import="com.bean.NTNIIBean" %>
<%@ page import="com.dao.DaoGT_NII" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Important Information's</title>
...
<tr>
	<td align="right">
	<a href='NewsSection/NewT_NII.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
