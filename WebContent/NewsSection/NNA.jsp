...
<%@ page import="com.controller.GetPostNNA" %>
<%@ page import="com.bean.NTNNABean" %>
<%@ page import="com.dao.DaoGT_NNA" %>
...
<tr>
	<td align="right">
	<a href='NewsSection/NewT_NNA.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
