...
<%@ page import="com.controller.GetPostCUE" %>
<%@ page import="com.bean.NTCUEBean" %>
<%@ page import="com.dao.DaoGT_CUE" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Upcoming C.S.R Events</title>
...
<tr>
	<td align="right">
	<a href='CSRSection/NewT_CUE.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
