...
<%@ page import="com.controller.GetPostCG" %>
<%@ page import="com.bean.NTCGBean" %>
<%@ page import="com.dao.DaoGT_CG" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>C.S.R Gallery</title>
...
<tr>
	<td align="right">
	<a href='CSRSection/NewT_CG.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
