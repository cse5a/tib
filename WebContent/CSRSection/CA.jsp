...
<%@ page import="com.controller.GetPostCA" %>
<%@ page import="com.bean.NTCABean" %>
<%@ page import="com.dao.DaoGT_CA" %>
<%@ page import="java.util.List" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>C.S.R Archives</title>
...
<tr>
	<td align="right">
	<a href='CSRSection/NewT_CA.jsp'><button type="submit" class="btn_default">New Topic</button></a>
	</td>
</tr>
</thead>
</table>
